...
class GameListFragment : Fragment() {
    ...
    private var filteredGameList = gameList
    ...
    override fun onCreateView(
        ...
        gameAdapter = GameAdapter(filteredGameList) { game: Game ->
    ...
    private fun filterGames(query: String?) {
        filteredGameList = if (query.isNullOrEmpty()) {
            gameList
        } else {
            gameList.filter {
        ...
        gameAdapter.updateGames(filteredGameList)
    }
}
